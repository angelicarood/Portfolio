...
export default function Intro() {
  return (
    <div className="container mx-auto ">
      <Image src={profilePic} alt="Profile" className="rounded-full w-64 h-64 md:w-50 md:h-50" />
      <h1 className="text-2xl md:text-4xl text-left font-semibold my-4">Software engineer and developer</h1>
      <p className="text-base md:text-lg text-left">
      An energetic and hardworking individual with excellent communication and organizational abilities. Experience in programming and web development. Experience in Java, C#, Phyton, JavaScript, React, HTML, and CSS. ESL teacher dedicated to creating an enjoyable classroom. Certified in TESOL AND TEFL.
      Fluent in Spanish, and English. Working on my Mandarin.
      </p>
      <ul className="flex">
        <li className="linkedin inline-block mr-3">
          <a href="https://www.linkedin.com/in/angelica-leon-rood/" target="_blank" rel="noopener noreferrer">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
        ...
        <li className="x inline-block mr-3 mt-1">
          <a href="https://twitter.com/X?ref_src=twsrc%5Egoogle%7Ctwcamp%5Eserp%7Ctwgr%5Eauthor" target="_blank" rel="noopener noreferrer">
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
        ...
        <li className="github inline-block mr-3">
          <a href="https://github.com/angelicarood" target="_blank" rel="noopener noreferrer">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
